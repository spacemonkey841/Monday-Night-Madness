...
class MenuCharacter extends FlxSprite
{
	private static var settings:Map<String, CharacterSetting> = [
		'bf' => new CharacterSetting(40, 30, 0.9, true),
		'gf' => new CharacterSetting(50, 80, 1.5, true),
		'dad' => new CharacterSetting(-15, 130),
		'spooky' => new CharacterSetting(20, 100),
		'pico' => new CharacterSetting(0, 50, 1.0, true),
		'mom' => new CharacterSetting(-30, 140, 1.0),
		'parents-christmas' => new CharacterSetting(100, 130, 1.8),
		'senpai' => new CharacterSetting(-40, 100, 1.4)
	];
